				...
				<div class="attempt-wrapper">
					<c:forEach var="usergame" items="${listGame}" varStatus="status">
						<div class="attempt">
							...
							${usergame.percentage}% | Feedback: <img src="./resources/images/star_yellow.png" width="25" height="25"><img src="./resources/images/star_yellow.png" width="25" height="25" class="img1"><span
								onclick="changeSlider(${usergame.attemptcount})"
